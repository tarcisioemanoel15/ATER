...
const numImpar = randomNumbers.filter(num => num % 2 === 1)
...
const AbaixoDE501 = crazyNumbers.reduce((accumulator, num) => {
...
const numbers0 = [5, 7, 3]
const aoQuadrado = numbers0.map(num => num ** 2)
...
const nomesFilmes = tvShows.map(filmes => filmes.name)
/*
...
const lista = cart.reduce((ac, { name }) => `${ac}- ${name}\n `, '')
console.log('EX 3 CONCLUIDO', lista)
/*
- Nome 1
- Nome 2
- Nome 3
